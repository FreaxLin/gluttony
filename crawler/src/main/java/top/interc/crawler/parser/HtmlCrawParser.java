...
public class HtmlCrawParser implements CrawContentParse {

    public static final Logger logger = LoggerFactory.getLogger(HtmlCrawParser.class);
    ...
    public HtmlCrawParser(CrawlerConfig crawlerConfig) {
    ...
    public Set<WebURL> getOutgoingUrls(String contextURL, HtmlContentHandler contentHandler, String contentCharset) throws UnsupportedEncodingException {
    ...
    @Override
    public ParseData parse(Page page, String contextURL) throws ParseException {
